...
public final class UIUtil {
	...
	/**
	 * @Auther: zml
	 * @Description: TODO 获得系统通知栏的高度
	 * @Date:2015-12-2下午12:23:27
	 * @param context
	 * @return
	 * @return int
	...
	public static void openHardwareAccelarate(Window window) {
		...
		if (Build.VERSION.SDK_INT >= 11) {
			try {
                ...
                Class clazz = Class
						.forName("android.view.WindowManager$LayoutParams");
				Field flagField = clazz
						.getDeclaredField("FLAG_HARDWARE_ACCELERATED");
				Field maskField = clazz
						.getDeclaredField("FLAG_HARDWARE_ACCELERATED");
				int flags = flagField.getInt(null);
				int mask = maskField.getInt(null);
				Method method = Window.class.getDeclaredMethod("setFlags",
						int.class, int.class);
				method.invoke(window, flags, mask);
			} catch (Exception e) {
				LogUtil.e(TAG, "openHardwareAccelarate()", e);
			}
		}
	}
	...
	public static void closeLayerHardware(View view) {
		if (Build.VERSION.RELEASE.startsWith("4.")) {
			try {
				...
				LogUtil.e(TAG, "closeLayerHardware()", e);
			}
		}
	}
	...
	/**
	 * @Auther: zml
	 * @Description: TODO 获取view的bitmap
